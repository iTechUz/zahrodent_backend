...
export interface IUserProfileDto {
    ...
    studentGroups: any[] // Agar studentGroupsning turi aniq bo‘lsa, shuni yozish mumkin
    teachingGroups: any[] // Xuddi shunday, aniq turi bo‘lsa
    roles: Roles
    branches: any[] // Agar branches turi aniq bo‘lsa, shuni yozish mumkin
    createdAt: string // yoki Date agar JSONni parse qilgandan keyin Date tipiga o‘tkazsangiz
    updatedAt: string // xuddi shunday Date ham bo‘lishi mumkin
}
